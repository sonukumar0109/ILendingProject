...
<body>
<h2 align="center" style="font-size:30px">User : Add</h2><br>
...
<div class="container">
    <h4 style="font-size:20px">User Detail</h4>
    <div class="form">
        <form:form action="createacustomer" method="post" >
            <table>
                ...
                <tr>
                    ...
                    <td><input type="number" name="organizationCode" id="organizationCode" placeholder="Enter Organization Code" required></td>
                </tr>
                <tr>
                    <td><label class="required" for="groupCode">Group Code</label></td>
                    <td><input type="text" name="groupCode" id="groupCode" placeholder="Enter Group Code"required></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="organizationName" id="organizationName" placeholder="Enter Organization Name"required></td>
                </tr>
                <tr>
                    <td><label class="required" for="groupName">Group Name</label></td>
                    <td><input type="text" name="groupName" id="groupName" placeholder="Enter Group Name"required></td>
                </tr>
                <tr>
                <td></td>
                    <td>
